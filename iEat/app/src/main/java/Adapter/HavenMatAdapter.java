...
public class HavenMatAdapter extends RecyclerView.Adapter<HavenMatAdapter.HavenMatViewHolder> {
    ...
    class HavenMatViewHolder extends RecyclerView.ViewHolder {
        ...
        public HavenMatViewHolder(View view) {
            super(view);
            imageView = (XCRoundRectImageView) view.findViewById(R.id.mat_rec_img);
            imageView.setType(XCRoundRectImageView.TYPE_ROUND);
            imageView.setRoundRadius(20);
            textView = (TextView) view.findViewById(R.id.mat_rec_text);
            textNuDtail = (TextView) view.findViewById(R.id.nutDetail);
            textNuDtail.getPaint().setFakeBoldText(true);
            nutrType[0] = (ImageView) view.findViewById(R.id.mat_type1);
            nutrType[1] = (ImageView) view.findViewById(R.id.mat_type2);
            nutrType[2] = (ImageView) view.findViewById(R.id.mat_type3);
            nutrType[3] = (ImageView) view.findViewById(R.id.mat_type4);
        }
    }
